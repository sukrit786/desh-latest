...
export class PatientComponent implements OnInit {
  ...
  modalRef: BsModalRef;
  constructor(public service: DataTransferService, public toastr: ToastrService, public el: ElementRef, public renderer: Renderer2, private modalService: BsModalService) { }
